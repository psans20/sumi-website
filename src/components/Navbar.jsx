...
function NavButton ({ title }) {
  return (
    <button className='border-black relative mr-4 border-2 h-[55px] w-60 md:h-[55px] md:w-56 rounded-full shadow-slate-500  shadow-md '>
      ...
      <span
        className='text-white text-2xl md:text-3xl text-center text-opacity-80  bg2 rounded-full absolute flex h-full w-full items-center justify-center top-0'
